...
export const Mediator: React.FC<MediatorProps> = () => {
	...
	return (
		<WebAppProvider children={
			<>
				<Main onSelectLanguage={setLanguage} onChangeRecipe={setText}
					onChangeArguments={setArguments} onChangeStdin={setStdin}
				/>
				<MainButton text='Execute' disabled={!didSelectLanguage && !didProvideRecipe}
